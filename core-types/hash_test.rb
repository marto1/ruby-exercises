...
class HashTest < Minitest::Test
  ...
  def test_invert_with_symbols
    ...
    expected_foods_with_many_colors = {
      ["green", "red", "yellow"]=>:apples, 
      ["brown", "red", "purple"]=>:potatoes}
  ...
  def test_merge_with_symbols
    new_restaurants = {cultura: "Latin American", 
                       wallys: "Wisconsin treats"}
    ...
    expected_favorite_restaurants = {cultura: "Latin American", 
                                     wallys: "Wisconsin treats"}
    expected_name_lengths = {maeby: 5, selena: 6}
    expected_planet_rings = {saturn: 7, 
                             jupiter: 3, 
                             uranus: 13, 
                             neptune: 6}
    expected_saturn = {saturn: 7}
    expected_tv_characters = {
      battlestar: ["Starbuck", "Apollo", "Boomer"],
      futurama:  ["Fry", "Leela", "Bender", "Zoidberg"],
      breaking_bad: "Walter White"
    }
    expected_shape_sides = {circle: 1, square: 4, circle: "infinite"}
  ...
  def test_update_with_symbols
    ...
    expected_favorite_restaurants = {
      "cultura": "Latin American", 
      "wallys": "Wisconsin treats"}
    expected_name_lengths = {maeby: 5, selena: 6}
    expected_name_lengths_2 = {maeby: 5, selena: 6}
    expected_planet_rings = {saturn: 7, jupiter: 3, 
                             uranus: 13, neptune: 6}
    expected_saturn = {saturn: 7, jupiter: 3, 
                       uranus: 13, neptune: 6}
    expected_tv_characters = {
      battlestar: ["Starbuck", "Apollo", "Boomer"],
      futurama: ["Fry", "Leela", "Bender", "Zoidberg"],
